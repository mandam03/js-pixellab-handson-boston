...
console.warn(`Afiseaza anul in care te-ai nascut scazand varsta pe
care ai trecut-o in obiect din anul curent (un proces numit hardcodare`);
...
console.log(object.name + ' s-a nascut in ' + object.year + '.');
